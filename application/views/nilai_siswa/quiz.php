<div class="container">
    ...
    <div class="row">
        <div class="col-lg-7 mx-auto">
            <div class="p-5">
                ...
                <form class="user" method="post" action="<?= base_url('nilai_siswa/quiz'); ?>">
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="keterangan" name="keterangan" value="Quiz" readonly>
                    </div>
    ...
    <h5 class="h5 mb-4 text-gray-800">Quiz</h5>
    ...
    <div class="col-md-8">
        <div class="card-body">
            <a href="<?= base_url('nilai_siswa/delete/') ?><?= $k['id']; ?>" class="badge bg-danger text-white" onClick="return confirm('Apakah anda yakin ingin menghapus data nilai ini?')"></a>
        </div>
    </div>
