<div class="container">
    ...
    <div class="row">
        <div class="col-lg-7 mx-auto">
            <div class="p-5">
                ...
                <form class="user" method="post" action="<?= base_url('nilai_siswa/posttest'); ?>">
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="keterangan" name="keterangan" value="Post-test" readonly>
                    </div>
    ...
    <h5 class="h5 mb-4 text-gray-800">Post-test</h5>
                ...
                <tbody>
                    ...
                    <?php foreach ($keterangan as $k) : ?>
                        <tr>
                            ...
                            <td><?= $k['nilai']; ?></td>
                            <td>
                                <a href="<?= base_url('nilai_siswa//') ?><?= $k['id']; ?>" class="badge bg-danger text-white" onClick="return confirm('Apakah anda yakin ingin menghapus data nilai ini?')"></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
