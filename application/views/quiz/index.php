                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <?php
                        $fitur = "SELECT * FROM user_fitur WHERE role_id = 4";
                    ...
                    <form action="<?= base_url('quiz/upload'); ?>" class="row g-3 " method="post" enctype="multipart/form-data">
                        <?= form_open_multipart('quiz/upload'); ?>
